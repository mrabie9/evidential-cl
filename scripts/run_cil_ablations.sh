...
JOBS=(
  ...
  # C-MAML
  "cmaml|cmaml_secondorder_se_cil|$IS|--second_order"                                       # M1 (turns SO on)
  "cmaml_no_replay|cmaml_noreplay_se_cil|$IS|"                                              # M2
  "cmaml_single_inner|cmaml_singleinner_se_cil|$IS|"                                        # M3
  "cmaml_alpha0|cmaml_alpha0_se_cil|$IS|"                                                   # M4
  # BCL-Dual
...
echo "[queue] results:      logs/<config_stem>/<expt_name>-<ts>/{0,39,55,7,13,21}/results.txt"
