...
JOBS=(
  ...
  # # C-MAML
  "cmaml|probe-fix_se_cil|$IS|--cmaml_joint_er"                                       # M1 (turns SO on)
  "cmaml|cmaml_secondorder_se_cil|$IS|--second_order --cmaml_joint_er"                                       # M1 (turns SO on)
  "cmaml_no_replay|cmaml_noreplay_se_cil|$IS| --cmaml_joint_er"                                              # M2
  "cmaml_single_inner|cmaml_singleinner_se_cil|$IS| --cmaml_joint_er"                                        # M3
  "cmaml_alpha0|cmaml_alpha0_se_cil|$IS| --cmaml_joint_er"                                                   # M4
  # # BCL-Dual
